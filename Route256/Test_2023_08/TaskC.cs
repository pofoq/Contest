    ...
    internal class TaskC : ITask
    {
        public void Run()
        {
            ...
            for (int i = 0; i < t; i++)
            {
                ...
                var temperature = new Temprature();
                var isError = false;
                for (int j = 0; j < n; j++)
                {
                    ...
                    var val = int.Parse(arr[1]);
                    var more = arr[0] == ">=";
                    if (more)
                    {
                        if (temperature.Max < val)
                        {
                            isError = true;
                            Console.WriteLine(-1);
                            continue;
                        }
                        if (temperature.Min < val)
                        {
                            temperature.Min = val;
                        }
                    }
                    ...
                    Console.WriteLine(temperature.GetValue(more));
                }
                Console.WriteLine();
            }
        }
